...
public class PagePlugin2 implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        PageParam pageParams = getPageParamForParamObj(parameterObject);
        ...
        // 获取相关配置的参数
        Integer pageNum = pageParams.getPageIndex() == null ? defaultPage : pageParams.getPageIndex();
    ...
    public PageParam getPageParamForParamObj(Object parameterObject) throws Exception {
        ...
        } else if (parameterObject instanceof PageParam) { // 参数是或者继承PageParam
