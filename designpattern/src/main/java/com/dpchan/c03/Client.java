package com.dpchan.c03;

import com.dpchan.c03.DIP.Fararry;
import com.dpchan.c03.DIP.IDriver;
import com.dpchan.c03.nonDIP.Benz;
import com.dpchan.c03.nonDIP.Driver;
...
public class Client {
    ...
    public void testDIPCarDriver(){
        ...
        IDriver driver = new com.dpchan.c03.DIP.Driver();
