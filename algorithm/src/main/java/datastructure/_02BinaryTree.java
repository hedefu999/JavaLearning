...
public class _02BinaryTree {
    public BinTreeNode plantATree(){
        ...
        BinTreeNode b8 = new BinTreeNode(8);
        BinTreeNode b11 = new BinTreeNode(11);
        b2.right = b3;
        b3.left = b5;
    ...
    //中序遍历 2 6 5 8 3
    //递归写法
    public void inorderTraversalRecursively(BinTreeNode root){
        if (root == null){
            return;
        }
    ...
    //堆栈写法
    public void inorderByStack2(BinTreeNode root){
    ...
    public void inorderByStack(BinTreeNode root){
        Stack<BinTreeNode> stack = new Stack<>();
    ...
    //前序遍历 23568
    public void preorderTraversalRecursively(BinTreeNode root){
        if (root == null){
            return;
        }
        System.out.print(root.val);
    ...
    public void preorderByStack2(BinTreeNode root){
        Stack<BinTreeNode> stack = new Stack<>();
        while (root != null){
            System.out.print(root.val);
            stack.push(root);
    ...
    public void preorderByStack3(BinTreeNode root){
        Stack<BinTreeNode> stack = new Stack<>();
        while (root != null || !stack.isEmpty()){
            while (root != null){
                System.out.print(root.val);
    ...
    //后序遍历 6 8 5 3 2
    public void postorderTraversalRecursively(BinTreeNode root){
        if (root == null){
            return;
        }
     ...
     */
    //错误写法记录
    public void postorderByStack2(BinTreeNode root){
        Stack<BinTreeNode> stack = new Stack<>();
        while (root != null){
            stack.push(root);
            root = root.left;
    ...
    * */
    public void postorderByStack(BinTreeNode root) {
        int left = 1;
        int right = 2;
        Stack<BinTreeNode> stack = new Stack<>();
     ...
     */
    //层次遍历
    public void levelTraversal(BinTreeNode root){
        if (root ==  null){
            return;
        }
        LinkedList<BinTreeNode> list = new LinkedList<>();
        list.add(root);
        BinTreeNode current;
        while (!list.isEmpty()){
    ...
    /**
     判断两棵树是否是同一棵树
     */
    public boolean testIsSameTree(BinTreeNode rootA, BinTreeNode rootB){
